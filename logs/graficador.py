...
nlogs=11
results = glt.parse('./C1_alpha09/*.log')
timelines=results.progress("nodelog")
print(timelines)
runs={}
for i in range(1,nlogs):
    runs[i]=timelines[timelines["LogFilePath"]=="./C1_alpha09/Class1_Instance-"+str(i)+"_0.9.log"]
...
fig1.update_layout(title_font_family="Times New Roman",title='$\\text{Class 1 Instances with } \\alpha=0.9$', title_x=0.5,paper_bgcolor='rgb(255,255,255)', plot_bgcolor='rgb(245,245,245)',legend=dict(bgcolor='rgb(255,255,255)',bordercolor="Black",borderwidth=2))
fig2.update_layout(title_font_family="Times New Roman",title='$\\text{Class 1 Instances with } \\alpha=0.9$', title_x=0.5,paper_bgcolor='rgb(255,255,255)', plot_bgcolor='rgb(245,245,245)',legend=dict(bgcolor='rgb(255,255,255)',bordercolor="Black",borderwidth=2))
